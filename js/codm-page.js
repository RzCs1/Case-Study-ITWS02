...
document.addEventListener("DOMContentLoaded", function () {
  ...
  gamedata.images.forEach((image) => {
    gameImagesHTML += `
      <img src="../img/games/codm/${image.imgsrc}" alt="${image.imgalt}" class="thumbnail">
    `;
  });
  ...
  gamedata.playersgallery.forEach((playersgallery) => {
    gameGalleryHTML += `
      <div class="thumbnail-wrapper">
        <img src="../img/games/codm/gallery/${playersgallery.imgsrc}" alt="${playersgallery.imgalt}" class="thumbnail">
        <div class="cap-desc">
      ...
      <div class="video-gallery-thumbnail-wrapper">
        <div class="video-gallery-thumbnail-container">
          <video class="video-gallery-thumbnail-video" muted loop>
            <source src="../video/codm/${video.videosrc}" type="video/mp4">
          </video>
        </div>
